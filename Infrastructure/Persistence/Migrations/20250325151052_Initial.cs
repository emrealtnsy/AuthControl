...
namespace AuthControl.Infrastructure.Persistence.Migrations
{
    /// <inheritdoc />
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoginAttempts_IpAddress_Username",
                table: "LoginAttempts",
                columns: new[] { "IpAddress", "Username" });

            migrationBuilder.CreateIndex(
                name: "IX_ReferralLinks_TokenHash",
                table: "ReferralLinks",
                column: "TokenHash",
                unique: true);
        }
